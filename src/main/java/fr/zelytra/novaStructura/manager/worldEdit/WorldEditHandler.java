package fr.zelytra.novaStructura.manager.worldEdit;
...
public class WorldEditHandler {
    ...
    public WorldEditHandler(Player player) {
        this.player = player;
    }
    ...
    public boolean saveStructure(String path) {
        ...
        File file = new File(path + this.structureName + ".struct");
        File folder = new File(NovaStructura.getInstance().getDataFolder().toString());
